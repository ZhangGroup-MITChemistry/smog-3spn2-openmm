...
columns = ['dna bond', 'dna angle', 'dna stacking', 'dna dihedral', 'dna base pair', 'dna cross stacking', 'all vdwl', 
           'all elec']
...
df_energies.round(6).to_csv(f'open3SPN2_{dna_type}_energy.csv', index=False)
